package br.com.contabil.subscription.config;
...
@OpenAPIDefinition(info = @Info(title = "Tabela de planos dos usuarios.", 
description = "Selecionar tabela de planos dos usuarios.",
contact = @Contact(name = "Davi de Moraes",
url = "http://contabil.com.br/", email = "contabil@gmail.com"),
license = @License(name = "MIT Licence")),
servers = @Server(url = "http://localhost:10097"))
